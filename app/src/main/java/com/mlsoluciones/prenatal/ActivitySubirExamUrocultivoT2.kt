...
class ActivitySubirExamUrocultivoT2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_subir_exam_urocultivo_t2)
    ...
    fun addImagen(v: View){
        ...
        var result = usersDBHelper.updateImgExamen("EXAMEN27", imgExamen)
    ...
    fun selImgExamen() {
        ...
        var imagens = usersDBHelper.selImgExamen("EXAMEN27")
