...
class ActivitySubirExamHepatitisT2 : AppCompatActivity() {
    ...
    fun addImagen(v: View){
        ...
        var result = usersDBHelper.updateImgExamen("EXAMEN22", imgExamen)
    ...
    fun selImgExamen() {
        ...
        var imagens = usersDBHelper.selImgExamen("EXAMEN22")
