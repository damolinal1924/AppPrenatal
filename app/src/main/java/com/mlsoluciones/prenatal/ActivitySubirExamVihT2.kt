...
class ActivitySubirExamVihT2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_subir_exam_vih_t2)
    ...
    fun addImagen(v: View){
        ...
        var result = usersDBHelper.updateImgExamen("EXAMEN20", imgExamen)
    ...
    fun selImgExamen() {
        ...
        var imagens = usersDBHelper.selImgExamen("EXAMEN20")
