...
class ActivitySubirExamUrocultivoT3 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_subir_exam_urocultivo_t3)
    ...
    fun addImagen(v: View){
        ...
        var result = usersDBHelper.updateImgExamen("EXAMEN43", imgExamen)
    ...
    fun selImgExamen() {
        ...
        var imagens = usersDBHelper.selImgExamen("EXAMEN43")
