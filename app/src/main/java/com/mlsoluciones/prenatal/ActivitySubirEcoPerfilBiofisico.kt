...
class ActivitySubirEcoPerfilBiofisico : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_subir_eco_perfil_biofisico)
    ...
    fun addImagen(v: View){
        ...
        var result = usersDBHelper.updateImgExamen("EXAMEN33", imgExamen)
    ...
    fun selImgExamen() {
        ...
        var imagens = usersDBHelper.selImgExamen("EXAMEN33")
